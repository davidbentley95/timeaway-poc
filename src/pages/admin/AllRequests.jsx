...
export default function AllRequests() {
  ...
  return (
    <div className="p-8">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-white">All Requests</h1>
        <p className="text-slate-400 text-sm mt-1">System-wide view of every request</p>
      </div>
      ...
      {selected && <RequestDetail request={selected} onClose={() => setSelected(null)} onRefresh={load} isAdmin />}
    </div>
  )
}
